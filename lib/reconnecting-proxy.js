...
var _twitterDisconnectError = require("./twitter-disconnect-error");

var _twitterDisconnectError2 = _interopRequireDefault(_twitterDisconnectError);
...
var ReconnectingProxy = (function (_Emitter) {
  ...
  _createClass(ReconnectingProxy, [{
    ...
    value: function getBackoffStrategySpec(err) {
      ...
      if (err instanceof _twitterDisconnectError2["default"]) {
        strategy = this.backoffStrategies.http_errors;
      }
